...
\immediate\write18{wget http://www.georgegaldorisi.com/wp-content/uploads/25mag-google4-cov-articleLarge.png}
...
\begin{figure}
    \centering
    \includegraphics{25mag-google4-cov-articleLarge.png}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
